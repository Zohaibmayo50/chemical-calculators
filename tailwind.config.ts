  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(102, 153, 51, 0.5), 0 0 20px rgba(102, 153, 51, 0.3)' },
          '100%': { boxShadow: '0 0 20px rgba(102, 153, 51, 0.8), 0 0 40px rgba(102, 153, 51, 0.5)' },
        },
        slideUp: {

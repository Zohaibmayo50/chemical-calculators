              ...
              <div className="sticky top-8 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 animate-slide-in-up animation-delay-400">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <Link href="/chemistry-formulas/reaction-quotient" className="text-tertiary-600 dark:text-tertiary-400 hover:text-tertiary-700 dark:hover:text-tertiary-300 transition-colors">
                          Reaction Quotient Formula
                        </Link>
                      </li>
                      <li>
                        <Link href="/chemistry-formulas/equilibrium-constant" className="text-tertiary-600 dark:text-tertiary-400 hover:text-tertiary-700 dark:hover:text-tertiary-300 transition-colors">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Reaction Quotient Calculator on ChemSolved",
            "url": "https://chemsolved.com/chemical-reaction-calculators/reaction-quotient-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Reaction Quotient Calculator",
                "item": "https://chemsolved.com/chemical-reaction-calculators/reaction-quotient-calculator"
              }
            ]
          })
        }}

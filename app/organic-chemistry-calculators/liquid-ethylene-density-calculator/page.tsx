      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-6 text-sm">
          <ol className="flex flex-wrap items-center gap-2 text-gray-600 dark:text-gray-400">
            <li><Link href="/" className="hover:text-cyan-600 dark:hover:text-cyan-400">Home</Link></li>
            <li>/</li>
            <li><Link href="/organic-chemistry-calculators" className="hover:text-cyan-600 dark:hover:text-cyan-400">Organic Chemistry Calculators</Link></li>
            <li>/</li>
            <li className="text-cyan-600 dark:text-cyan-400 font-semibold">Liquid Ethylene Density</li>
          </ol>
        </nav>

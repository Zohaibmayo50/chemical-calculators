          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a
                    href="/solution-calculators/dilution-calculator"
                    className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                  >
                    <span>→</span>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <ul className="space-y-3">
                  <li>
                    <a
                      href="/chemistry-formulas/colligative-properties-formula"
                      className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                    >
                      <span>→</span>
                      <span>Colligative Properties Formula</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      <span>→</span>
                      <span>Osmotic Pressure Formula</span>
                    </a>
                  </li>
                </ul>
              </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Colligative Properties Calculator on ChemSolved",
            "url": "https://chemsolved.com/solution-calculators/colligative-properties-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Colligative Properties Calculator",
                "item": "https://chemsolved.com/solution-calculators/colligative-properties-calculator"
              }
            ]
          })
        }}

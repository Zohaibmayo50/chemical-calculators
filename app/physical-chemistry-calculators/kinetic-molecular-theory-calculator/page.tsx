            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <ul className="space-y-3">
                  <li>
                    <a
                      href="/chemistry-formulas/kinetic-molecular-theory-formula"
                      className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                    >
                      <span>→</span>
                      <span>Kinetic Molecular Theory Formula</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      <span>→</span>
                      <span>RMS Velocity Formula</span>
                    </a>
                  </li>
                </ul>
              </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Kinetic Molecular Theory Calculator",
            "description": "Kinetic Molecular Theory Calculator on ChemSolved",
            "url": "https://chemsolved.com/physical-chemistry-calculators/kinetic-molecular-theory-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Kinetic Molecular Theory Calculator",
                "item": "https://chemsolved.com/physical-chemistry-calculators/kinetic-molecular-theory-calculator"
              }
            ]
          })
        }}

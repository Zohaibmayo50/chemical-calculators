      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Henderson Hasselbalch Calculator on ChemSolved",
            "url": "https://chemsolved.com/atomic-structure-calculators/henderson-hasselbalch-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Henderson Hasselbalch Calculator",
                "item": "https://chemsolved.com/atomic-structure-calculators/henderson-hasselbalch-calculator"
              }
            ]
          })
        }}

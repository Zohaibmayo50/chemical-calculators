          ...
          <div className="mt-12 prose prose-lg max-w-none dark:prose-invert">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
                Understanding Wavelength, Energy, and Frequency
              </h2>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-3">
                      <li>
                        ...
                        >
                          <span>→</span>
                          <span>Wavelength-Energy Formula</span>
                        </a>
                      </li>
                      <li>
                        <a
                          href="/chemistry-formulas/planck-equation"
                          className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                        >
                          <span>→</span>
                          <span>Planck Equation</span>
                        </a>
                      </li>
                    </ul>
                  </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Wavelength Energy Calculator",
            "description": "Wavelength Energy Calculator on ChemSolved",
            "url": "https://chemsolved.com/atomic-structure-calculators/wavelength-energy-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Wavelength Energy Calculator",
                "item": "https://chemsolved.com/atomic-structure-calculators/wavelength-energy-calculator"
              }
            ]
          })
        }}

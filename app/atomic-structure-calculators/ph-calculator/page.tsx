...
export const metadata: Metadata = {
  title: 'pH Calculator | Calculate pH from Hâº Concentration',
  ...
  openGraph: {
    ...
    description: 'Calculate pH from Hâº concentration instantly. Determine acidity or basicity with our free pH calculator.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://chemsolved.com/atomic-structure-calculators/ph-calculator'
  }
};
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-2">Find Hâº from pH</p>
                  <p className="text-lg font-mono font-bold text-gray-900 dark:text-white">[Hâº] = 10â»áµ–á´´</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                    <span className="font-mono font-bold text-primary-600 dark:text-primary-400 min-w-[60px]">[Hâº]</span>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">[Hâº] = 1.0 Ã— 10â»âµ M</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">pH = -logâ‚â‚€(1.0 Ã— 10â»âµ)</p>
                  </div>
                </div>
                <div className="flex gap-4">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r-lg">
                  ...
                  <p className="text-sm text-red-800 dark:text-red-400">pH = -log[Hâº], not log[Hâº]</p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r-lg">
                  <p className="font-semibold text-red-900 dark:text-red-300 mb-1">Using natural logarithm</p>
                  <p className="text-sm text-red-800 dark:text-red-400">Use logâ‚â‚€ (base 10), not ln (natural log)</p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r-lg">
                  <p className="font-semibold text-red-900 dark:text-red-300 mb-1">Confusing [Hâº] with pH</p>
                  <p className="text-sm text-red-800 dark:text-red-400">Higher pH = lower [Hâº] (inverse relationship)</p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r-lg">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Link href="/acid-base-calculators/pka-calculator" className="block p-4 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-900/30 dark:to-accent-900/30 rounded-xl border-2 border-primary-200 dark:border-primary-700 hover:scale-105 transition-transform">
                ...
                <Link href="/concentration-and-solution-calculators/dilution-calculator" className="block p-4 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-900/30 dark:to-accent-900/30 rounded-xl border-2 border-primary-200 dark:border-primary-700 hover:scale-105 transition-transform">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Calculate solution dilution (Mâ‚Vâ‚ = Mâ‚‚Vâ‚‚)</p>
                </Link>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-4">
                <Link href="/atomic-structure-calculators" className="block p-4 bg-gray-100 dark:bg-gray-700 rounded-xl border-2 border-gray-300 dark:border-gray-600 hover:scale-105 transition-transform">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">All Atomic Structure Calculators â†’</h3>
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <details className="group">
                  ...
                  <p className="mt-3 pl-4 text-gray-700 dark:text-gray-300">
                    pH 7 is neutral, meaning equal concentrations of Hâº and OHâ» ions ([Hâº] = 1.0 Ã— 10â»â· M). Pure water at 25Â°C has pH 7. pH &lt; 7 is acidic, pH &gt; 7 is basic.
                  </p>
                </details>
                <details className="group">
                  <summary className="cursor-pointer font-semibold text-gray-900 dark:text-white p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                ...
                <details className="group">
                  ...
                  <p className="mt-3 pl-4 text-gray-700 dark:text-gray-300">
                    Yes, for extremely concentrated acids or bases. For example, 10 M HCl has pH â‰ˆ -1. However, the 0-14 scale covers most common aqueous solutions.
                  </p>
                </details>
                <details className="group">
                  <summary className="cursor-pointer font-semibold text-gray-900 dark:text-white p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <p className="mt-3 pl-4 text-gray-700 dark:text-gray-300">
                    pH + pOH = 14 at 25Â°C. pOH measures hydroxide ion concentration (pOH = -log[OHâ»]). Knowing one allows you to calculate the other.
                  </p>
                </details>
                <details className="group">
                  <summary className="cursor-pointer font-semibold text-gray-900 dark:text-white p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <p className="mt-3 pl-4 text-gray-700 dark:text-gray-300">
                    The logarithmic scale compresses the wide range of Hâº concentrations (10â° to 10â»Â¹â´ M) into a manageable 0-14 scale. Each pH unit represents a 10-fold difference in acidity.
                  </p>
                </details>
                <details className="group">
                  <summary className="cursor-pointer font-semibold text-gray-900 dark:text-white p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Ph Calculator",
            "description": "Ph Calculator on ChemSolved",
            "url": "https://chemsolved.com/atomic-structure-calculators/ph-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Ph Calculator",
                "item": "https://chemsolved.com/atomic-structure-calculators/ph-calculator"
              }
            ]
          })
        }}

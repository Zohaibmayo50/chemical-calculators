                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <a
                          href="/chemistry-formulas/collision-theory"
                          className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                        >
                          <span>→</span>
                          <span>Collision Theory Formula</span>
                        </a>
                      </li>
                      <li>
                        <a
                          href="/chemistry-formulas/arrhenius-equation"
                          className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                        >
                          <span>→</span>
                          <span>Arrhenius Equation</span>
                        </a>
                      </li>
                    </ul>
                  </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Collision Theory Calculator",
            "description": "Collision Theory Calculator on ChemSolved",
            "url": "https://chemsolved.com/kinetics-calculators/collision-theory-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Collision Theory Calculator",
                "item": "https://chemsolved.com/kinetics-calculators/collision-theory-calculator"
              }
            ]
          })
        }}

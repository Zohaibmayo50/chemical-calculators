                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <a
                          href="/chemistry-formulas/reaction-order-formula"
                          className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                        >
                          <span>→</span>
                          <span>Reaction Order Formula</span>
                        </a>
                      </li>
                      <li>
                        <a
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Reaction Order Calculator",
            "description": "Reaction Order Calculator on ChemSolved",
            "url": "https://chemsolved.com/kinetics-calculators/reaction-order-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Reaction Order Calculator",
                "item": "https://chemsolved.com/kinetics-calculators/reaction-order-calculator"
              }
            ]
          })
        }}

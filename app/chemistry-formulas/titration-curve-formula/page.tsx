              ...
              <div className="bg-gradient-to-r from-pink-50 to-fuchsia-50 dark:from-pink-900/30 dark:to-fuchsia-900/30 rounded-xl p-8">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    At V = Â½V<sub>eq</sub>: [HA] = [Aâ»], maximum buffer capacity
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-rose-50 dark:bg-rose-900/20 rounded-xl p-6">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-6">
                  <p className="font-mono text-lg text-center mb-4">pH = pKa + log([Aâ»]/[HA])</p>
                  <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                    <p>[Aâ»] = moles base added / total volume</p>
              ...
              <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-6 text-center">
                  <p className="font-mono text-lg mb-2">pH = 7 + Â½(pKa + pKw)</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">or pH = Â½(pKw + pKa + log C)</p>
              ...
              <div className="bg-fuchsia-50 dark:bg-fuchsia-900/20 rounded-xl p-6">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-6">
                  ...
                  <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                    <p>[OHâ»] = (moles base - moles acid) / total volume</p>
                    <p>pOH = -log[OHâ»]</p>
                    <p>pH = 14 - pOH</p>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                  <li>â€¢ Low initial pH (&lt;2)</li>
                  <li>â€¢ Sharp vertical rise at equivalence</li>
                  <li>â€¢ Equivalence point pH = 7.00</li>
                  <li>â€¢ Large pH jump (~6 units)</li>
                  <li>â€¢ No buffer region</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                  <li>â€¢ Higher initial pH (2-6)</li>
                  <li>â€¢ Buffer region before equivalence</li>
                  <li>â€¢ Equivalence point pH &gt; 7</li>
                  <li>â€¢ Smaller pH jump (~3-4 units)</li>
                  <li>â€¢ pH = pKa at half-equivalence</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                  <li>â€¢ Multiple equivalence points</li>
                  <li>â€¢ One per ionizable Hâº</li>
                  <li>â€¢ Multiple buffer regions</li>
                  <li>â€¢ pH = pKa at each half-equivalence</li>
                  <li>â€¢ Example: Hâ‚‚SOâ‚„ has 2 steps</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                  <li>â€¢ Choose indicator with pKa â‰ˆ pH<sub>eq</sub></li>
                  <li>â€¢ Color change at pH â‰ˆ pK<sub>In</sub></li>
                  <li>â€¢ Strong-strong: phenolphthalein (pH 8-10)</li>
                  <li>â€¢ Weak-strong: varies by equivalence pH</li>
                  <li>â€¢ Endpoint â‰ˆ equivalence point</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 rounded-xl p-6">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <p className="ml-6">(0.100)(25.0) = (0.100)(Vâ‚‚)</p>
                  <p className="ml-6">Vâ‚‚ = 25.0 mL</p>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  <p><strong>Problem:</strong> 50.0 mL of 0.10 M acetic acid (Ka = 1.8Ã—10â»âµ) titrated with 0.10 M NaOH. Find pH at 25.0 mL added.</p>
                  <p className="mt-4"><strong>Solution:</strong></p>
                  <p className="ml-6">Equivalence volume = 50.0 mL</p>
                  <p className="ml-6">At 25.0 mL: half-equivalence point</p>
                  <p className="ml-6">pH = pKa = -log(1.8Ã—10â»âµ)</p>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <p className="mt-4"><strong>Solution:</strong></p>
                  <p className="ml-6">Initial moles CHâ‚ƒCOOH = 0.10 Ã— 0.050 = 0.0050 mol</p>
                  <p className="ml-6">Moles NaOH added = 0.10 Ã— 0.040 = 0.0040 mol</p>
                  <p className="ml-6">Moles CHâ‚ƒCOOH remaining = 0.0050 - 0.0040 = 0.0010 mol</p>
                  <p className="ml-6">Moles CHâ‚ƒCOOâ» formed = 0.0040 mol</p>
                  <p className="ml-6">Total volume = 50.0 + 40.0 = 90.0 mL</p>
                  <p className="ml-6 mt-4">pH = pKa + log([Aâ»]/[HA])</p>
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl p-6">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <p className="ml-6">Excess NaOH = 0.10 Ã— 0.010 = 0.0010 mol</p>
                  <p className="ml-6">Total volume = 50.0 + 60.0 = 110.0 mL</p>
                  <p className="ml-6">[OHâ»] = 0.0010 / 0.110 = 9.1Ã—10â»Â³ M</p>
                  <p className="ml-6">pOH = -log(9.1Ã—10â»Â³) = 2.04</p>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 rounded-2xl shadow-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/acid-base-calculators/titration-calculator" className="block p-6 bg-gradient-to-r from-rose-600 to-pink-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all">

      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <a href="/chemistry-formulas/half-life-formula" className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <h3 className="font-semibold text-blue-600 mb-2">Half-Life Formula</h3>
              <p className="text-sm text-gray-600">Radioactive decay calculations</p>
            </a>
            <a href="/chemistry-formulas/percent-yield-formula" className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <h3 className="font-semibold text-blue-600 mb-2">Percent Yield</h3>
              <p className="text-sm text-gray-600">Reaction efficiency calculations</p>
            </a>
          </div>
        </div>

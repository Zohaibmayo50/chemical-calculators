...
export const metadata: Metadata = {
  ...
  description: 'Calculate formal charge (FC = V - N - B/2) for Lewis structures. Determine electron distribution, predict molecular stability, and identify resonance structures.',
  alternates: {

      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-teal-50 border-l-4 border-teal-500 p-4 mb-4 text-center">
            <p className="text-2xl font-bold text-teal-700">For aA + bB â‡Œ cC + dD:</p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded ">
            <p className="text-lg font-mono text-center mb-3">Kp = Kc (RT)^Î”n</p>
            <div className="text-gray-700">
              <p className="mb-2"><strong>Where:</strong></p>
              <ul className="list-disc pl-5 space-y-1">
                <li>R = gas constant (0.08206 LÂ·atm/molÂ·K)</li>
                <li>T = absolute temperature (K)</li>
                <li>Î”n = (moles gas products) âˆ’ (moles gas reactants)</li>
              </ul>
              <p className="mt-3 text-sm text-gray-600"><strong>Note:</strong> If Î”n = 0, then Kp = Kc</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-700 mb-3"><strong>Reaction:</strong> N2 + 3 H2 â‡Œ 2 NH3</p>
          ...
          <div className="space-y-2 text-gray-700 bg-gray-50 p-4 rounded">
            <p>Kc = [NH3]Â² / ([N2][H2]Â³)</p>
            <p>Kc = (0.20)Â² / ((0.10)(0.30)Â³)</p>
            <p>Kc = 0.04 / (0.10 Ã— 0.027)</p>
            <p>Kc = 0.04 / 0.0027 â‰ˆ 14.8</p>
          </div>
          <div className="bg-green-50 border border-green-200 rounded p-4 mt-4">
            <p className="font-semibold">Answer: Kc â‰ˆ 14.8</p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-blue-50 p-4 rounded mb-3">
            <p className="text-center font-mono">ln(K2/K1) = -(Î”HÂ°/R)(1/T2 - 1/T1)</p>
          </div>
          <div className="grid md:grid-cols-2 gap-4 text-gray-700">
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="font-semibold text-red-700">Endothermic Reactions (Î”HÂ° &gt; 0)</h3>
              <p>Increasing temperature increases K, favoring products.</p>
            </div>
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-blue-700">Exothermic Reactions (Î”HÂ° &lt; 0)</h3>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <a href="/chemical-reaction-calculators/reaction-quotient-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">

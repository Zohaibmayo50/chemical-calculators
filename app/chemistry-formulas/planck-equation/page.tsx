...
export const metadata: Metadata = {
  ...
  description: 'Calculate photon energy using Planck\'s equation (E = hν). Relate energy, frequency, and wavelength for electromagnetic radiation and quantum mechanics applications.',
  alternates: {

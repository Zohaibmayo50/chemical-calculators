      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/" className="block p-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <Link href="/physical-chemistry-calculators/raoults-law-calculator" className="block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <Link href="/mass-percent-vs-mole-fraction" className="block p-6 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all">
                ...
                <p className="text-white/90">Compare composition methods</p>
              </Link>
            </div>
          </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "TechArticle",
            "headline": "Mole Fraction Formula",
            "description": "Mole Fraction Formula on ChemSolved",
            "url": "https://chemsolved.com/chemistry-formulas/mole-fraction-formula",
            "author": {
              "@type": "Person",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://chemsolved.com/chemistry-formulas/mole-fraction-formula"
              }
            ]
          })
        }}

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/chemistry-formulas/enthalpy-reaction-formula',
  },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "TechArticle",
            "headline": "Enthalpy Reaction Formula",
            "description": "Enthalpy Reaction Formula on ChemSolved",
            "url": "https://chemsolved.com/chemistry-formulas/enthalpy-reaction-formula",
            "author": {
              "@type": "Person",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Enthalpy Reaction Formula",
                "item": "https://chemsolved.com/chemistry-formulas/enthalpy-reaction-formula"
              }
            ]
          })
        }}

        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="my-12 p-8 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-xl">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center">
              <p className="text-5xl font-bold text-gray-900 dark:text-white mb-2">
                Mass % = (mass<sub>part</sub> / mass<sub>total</sub>) × 100%
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg p-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded mb-3">
                  <p className="text-2xl font-bold text-blue-600 mb-2">
                    % = (m<sub>solute</sub> / m<sub>solution</sub>) × 100%
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded mb-3">
                  <p className="text-2xl font-bold text-purple-600 mb-2">
                    % = (m<sub>element</sub> / m<sub>compound</sub>) × 100%
                  </p>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-blue-100 dark:bg-blue-900/30 rounded-lg p-6">
                ...
                <p className="text-2xl font-bold text-blue-800 dark:text-blue-200">
                  % = (m<sub>part</sub> / m<sub>total</sub>) × 100
                </p>
              </div>
              ...
              <div className="bg-green-100 dark:bg-green-900/30 rounded-lg p-6">
                ...
                <p className="text-2xl font-bold text-green-800 dark:text-green-200">
                  m<sub>total</sub> = (m<sub>part</sub> × 100) / %
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="font-mono bg-white dark:bg-gray-800 p-3 rounded">
                    Mass % = (mass<sub>sugar</sub> / mass<sub>total</sub>) × 100%
                  </p>
                </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-lg mb-2">Step 1: Calculate molar mass of H₂O</h4>
                  <p className="font-mono bg-white dark:bg-gray-800 p-3 rounded">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">Step 2: Mass of oxygen in 1 mole H₂O</h4>
                  <p className="font-mono bg-white dark:bg-gray-800 p-3 rounded">
                    mass<sub>O</sub> = 16.00 g (in 1 mol H₂O)
                  </p>
                </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-6 rounded-lg">
                <h3 className="font-bold text-red-900 dark:text-red-100 mb-2">❌ Using mass of solvent instead of total mass</h3>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-6 rounded-lg">
                <h3 className="font-bold text-red-900 dark:text-red-100 mb-2">❌ Confusing with molarity</h3>
                <p className="text-red-800 dark:text-red-200">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/solution-calculators/mass-percent-calculator" className="block p-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all">
              ...
              <Link href="/solution-calculators/solution-preparation-calculator" className="block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all">

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/chemistry-formulas/quantum-numbers',
  },
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl shadow-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/chemistry-formulas/quantum-numbers" className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
              ...
              <Link href="/atomic-structure-calculators/electron-configuration-calculator" className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "TechArticle",
            "headline": "Quantum Numbers",
            "description": "Quantum Numbers on ChemSolved",
            "url": "https://chemsolved.com/chemistry-formulas/quantum-numbers",
            "author": {
              "@type": "Person",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://chemsolved.com/chemistry-formulas/quantum-numbers"
              }
            ]
          })
        }}

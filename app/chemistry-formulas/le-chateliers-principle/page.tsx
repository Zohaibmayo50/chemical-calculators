  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4 text-gray-700">
            <div className="bg-amber-50 p-4 rounded">
              ...
              <p>Add reactant â†’ shifts right (toward products)</p>
              <p>Add product â†’ shifts left (toward reactants)</p>
              <p>Remove species â†’ shifts to replace it</p>
            </div>
            <div className="bg-amber-50 p-4 rounded">
              <h3 className="font-bold text-amber-700 mb-2">2. Pressure/Volume Change (gases)</h3>
              <p>Increase pressure (decrease V) â†’ shifts to side with fewer gas molecules</p>
              <p>Decrease pressure (increase V) â†’ shifts to side with more gas molecules</p>
            </div>
            <div className="bg-amber-50 p-4 rounded">
              <h3 className="font-bold text-amber-700 mb-2">3. Temperature Change</h3>
              <p>Raise T â†’ shifts in endothermic direction (absorbs heat)</p>
              <p>Lower T â†’ shifts in exothermic direction (releases heat)</p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Example: Nâ‚‚ + 3Hâ‚‚ â‡Œ 2NHâ‚ƒ (Î”H &lt; 0, exothermic)</h2>
          <div className="space-y-2 text-gray-700">
            <p><strong>Add Nâ‚‚:</strong> Shifts right â†’ more NHâ‚ƒ produced</p>
            <p><strong>Increase pressure:</strong> Shifts right (4 mol gas â†’ 2 mol gas)</p>
            <p><strong>Increase temperature:</strong> Shifts left (endothermic direction)</p>
            <p><strong>Remove NHâ‚ƒ:</strong> Shifts right â†’ produces more NHâ‚ƒ</p>
          </div>
        </section>

      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-rose-50 border-l-4 border-rose-500 p-4 mb-4 text-center">
            <p className="text-2xl font-bold text-rose-700">N = N₀ e^(−λt)</p>
            <p className="text-lg text-rose-700 mt-2">λ = ln(2) / t<sub>1/2</sub></p>
          </div>
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-start">
              <span className="font-semibold text-gray-800 min-w-[140px]">λ:</span>
              <span className="text-gray-700">Decay constant, probability of decay per unit time (s⁻¹, h⁻¹, or year⁻¹)</span>
            </div>
            <div className="flex items-start">
              <span className="font-semibold text-gray-800 min-w-[140px]">t:</span>
              <span className="text-gray-700">Elapsed time (seconds, hours, days, or years—must match λ units)</span>
            </div>
            <div className="flex items-start">
              <span className="font-semibold text-gray-800 min-w-[140px]">t<sub>1/2</sub>:</span>
              <span className="text-gray-700">Half-life, time for N to decrease to N₀/2 (same time units as t)</span>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-6">
            ...
            <ul className="list-disc pl-5 text-gray-700 space-y-1">
              <li>N = N₀ (1/2)^(t/t<sub>1/2</sub>) — using half-life directly</li>
              <li>Activity: A = A₀ e^(−λt) — decay rate in becquerels (Bq)</li>
              <li>ln(N/N₀) = −λt — linearized form useful for graphing</li>
            </ul>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-red-50 border-l-4 border-red-500 p-4">
              ...
              <p className="text-gray-700">The decay constant λ and time t must have reciprocal units. If λ is in h⁻¹, t must be in hours. Mixing hours and seconds produces completely incorrect results.</p>
            </div>
            <div className="bg-red-50 border-l-4 border-red-500 p-4">
              <h3 className="font-semibold text-red-900 mb-2">Mistake 2: Forgetting the Negative Sign</h3>
              <p className="text-gray-700">The exponent must be negative (−λt), not positive. A positive exponent would incorrectly predict exponential growth instead of decay.</p>
            </div>
            <div className="bg-red-50 border-l-4 border-red-500 p-4">
              <h3 className="font-semibold text-red-900 mb-2">Mistake 3: Using Wrong Base for Logarithm</h3>
              <p className="text-gray-700">Always use natural logarithm ln(2) ≈ 0.693, not log₁₀(2) ≈ 0.301. The exponential decay formula requires the natural base e.</p>
            </div>
            <div className="bg-red-50 border-l-4 border-red-500 p-4">
              <h3 className="font-semibold text-red-900 mb-2">Mistake 4: Confusing Activity and Amount</h3>
              <p className="text-gray-700">Both amount (N) and activity (A = λN) follow exponential decay with the same λ, but they have different units and meanings. Activity is measured in becquerels (decays per second).</p>
            </div>
          </div>
        </section>

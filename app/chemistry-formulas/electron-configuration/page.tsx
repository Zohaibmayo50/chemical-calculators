    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Developed from quantum mechanics in the early 20th century, electron configuration follows specific rules derived from the physics of atomic orbitals. Niels Bohr's model introduced energy levels, while later quantum mechanical treatments by SchrÃ¶dinger, Heis enberg, and Pauli provided the mathematical foundation for modern orbital theory and the principles governing electron arrangement.
          </p>
          <p className="text-gray-700">
            The electron configuration notation uses numbers (principal quantum number n) and letters (orbital type: s, p, d, f) with superscripts showing electron count. For example, 1sÂ² 2sÂ² 2pâ¶ represents neon's configuration with completely filled first and second shells, explaining its chemical inertness as a noble gas.
          </p>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <div className="bg-green-50 p-4 rounded border-l-4 border-green-500">
              ...
              <p className="mb-2">No two electrons can have identical quantum numbers. Maximum 2 electrons per orbital with opposite spins (â†‘â†“).</p>
            ...
            <div className="bg-purple-50 p-4 rounded border-l-4 border-purple-500">
              ...
              <p className="text-sm">Example: pÂ³ is â†‘ â†‘ â†‘ (all singly occupied) not â†‘â†“ â†‘ (one paired).</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-3 text-gray-700 bg-gray-50 p-4 rounded">
            ...
            <p><strong>Step 3:</strong> Apply Hund's to 2pâ´: â†‘â†“ â†‘ â†‘</p>
            <p><strong>Configuration:</strong> 1sÂ² 2sÂ² 2pâ´</p>
          </div>
          <div className="bg-green-50 border border-green-200 rounded p-4 mt-4">
            <p className="font-semibold">Answer: 1sÂ² 2sÂ² 2pâ´</p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-gray-700">
            <div className="bg-orange-50 p-4 rounded">
              ...
              <p><strong>Expected:</strong> [Ar] 4sÂ² 3dâ´</p>
              <p><strong>Actual:</strong> [Ar] 4sÂ¹ 3dâµ</p>
              <p className="text-sm mt-2">Half-filled dâµ provides extra stability</p>
            </div>
            <div className="bg-orange-50 p-4 rounded">
              <h3 className="font-semibold text-orange-900 mb-2">Copper (Cu, Z=29)</h3>
              <p><strong>Expected:</strong> [Ar] 4sÂ² 3dâ¹</p>
              <p><strong>Actual:</strong> [Ar] 4sÂ¹ 3dÂ¹â°</p>
              <p className="text-sm mt-2">Fully filled dÂ¹â° more stable</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a href="/atomic-structure-calculators/electron-configuration-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
            ...
            <a href="/chemistry-formulas/quantum-numbers" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">

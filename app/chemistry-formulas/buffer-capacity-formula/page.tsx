    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-700">Units are typically mol per pH unit per liter of buffer (mol/LÂ·pH).</p>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-sm text-gray-600 mt-3">For theoretical estimates near pKa: beta â‰ˆ 2.303 * C_total * (Ka*[H+] / (Ka + [H+])^2)</p>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-3 text-gray-700">
            ...
            <p>3) Per liter: divide by volume 0.20 L â†’ 0.025 mol/(LÂ·pH)</p>
          </div>
          <div className="bg-green-50 border border-green-200 rounded p-4 mt-4">
            <p className="font-semibold">Answer: beta â‰ˆ 0.025 mol per liter per pH unit</p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-gray-700">
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <p>Capacity is maximum near pH â‰ˆ pKa; drops when pH is far from pKa.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a href="/acid-base-calculators/pka-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
            ...
            <a href="/atomic-structure-calculators/henderson-hasselbalch-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">

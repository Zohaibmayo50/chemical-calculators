...
export const metadata: Metadata = {
  ...
  description: 'Calculate parts per million (ppm) concentration for trace substances. Formula: ppm = (mass solute/mass solution) × 10⁶. Essential for water quality and analytics.',
  alternates: {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            The beauty of ppm lies in its versatility—it can be expressed as mass per mass (mg/kg), volume per volume (mL/L for gases), or mass per volume (mg/L for liquids). For dilute aqueous solutions where the density is approximately 1 g/mL, the conversion between mg/L and ppm is straightforward: 1 mg/L = 1 ppm. This simplification makes water quality testing particularly convenient, as most natural waters and dilute solutions have densities very close to pure water.
          </p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-lime-50 border-l-4 border-lime-500 p-4 mb-4 text-center">
            <p className="text-2xl font-bold text-lime-700">ppm = (mass_solute / mass_solution) × 10⁶</p>
          </div>
          
          <div className="space-y-4 text-gray-700 mt-4">
            <div className="bg-gray-50 p-4 rounded">
              <p className="font-semibold text-lime-700">For Mass-Based Concentrations:</p>
              <p className="font-mono mt-2">ppm = (mg solute / kg solution) = (g solute / 10⁶ g solution)</p>
            </div>
            
            <div className="bg-gray-50 p-4 rounded">
              <p className="font-semibold text-lime-700">For Aqueous Solutions (ρ ≈ 1 g/mL):</p>
              <p className="font-mono mt-2">ppm ≈ mg/L = μg/mL</p>
            </div>
            
            <div className="bg-gray-50 p-4 rounded">
              <p className="font-semibold text-lime-700">For Gaseous Mixtures (by volume):</p>
              <p className="font-mono mt-2">ppmv = (volume solute / volume total) × 10⁶</p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="bg-lime-50 border-l-4 border-lime-600 p-4 mb-4">
            ...
            <p className="text-gray-700 mt-2"><strong>Given:</strong> 5.0 mg of fluoride (F⁻) dissolved in 2.0 L of water. Assume water density = 1.00 g/mL.</p>
          </div>
          ...
          <div className="space-y-3 text-gray-700">
            <div className="bg-white border-l-4 border-lime-500 pl-4 py-2">
              ...
              <p>Mass = Volume × Density = 2000 mL × 1.00 g/mL = 2000 g</p>
            </div>
            ...
            <div className="bg-white border-l-4 border-lime-500 pl-4 py-2">
              ...
              <p>ppm = (mass of solute / mass of solution) × 10⁶</p>
              <p>ppm = (0.005 g / 2000 g) × 10⁶</p>
              <p>ppm = 2.5 × 10⁻⁶ × 10⁶ = 2.5 ppm</p>
            </div>
            
            <div className="bg-white border-l-4 border-lime-500 pl-4 py-2">
              <p className="font-semibold text-lime-700">Step 4: Verify using mg/L approximation</p>
              <p>Concentration = 5.0 mg / 2.0 L = 2.5 mg/L ≈ 2.5 ppm ✓</p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-6">
                ...
                <table className="w-full border-collapse text-gray-700">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-gray-300 p-2">1/10²</td>
            ...
            <div>
              ...
              <p className="text-gray-700">For gaseous mixtures, ppm is typically expressed by volume (ppmv). At constant temperature and pressure, Avogadro's law states that equal volumes contain equal numbers of molecules, making volume-based measurements convenient. For example, 400 ppmv CO₂ in air means 400 volumes of CO₂ per 1 million volumes of air.</p>
            </div>
            
            <div>
              <h3 className="text-xl font-semibold text-lime-700 mb-2">3. Temperature and Pressure Corrections</h3>
              <p className="text-gray-700">For gas phase ppm calculations, concentrations may need correction to standard temperature and pressure (STP: 0°C, 1 atm) or other reference conditions. Use the ideal gas law relationship: C₁/T₁ = C₂/T₂ (at constant pressure) to adjust concentrations between different temperatures.</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 text-gray-700 space-y-1 mt-2">
                <li>1 ppm = 1 mg/L (for aqueous solutions with ρ ≈ 1 g/mL)</li>
                <li>1 ppm = 1 μg/mL = 1 μg/g (for water)</li>
                <li>1% = 10,000 ppm</li>
                <li>1 ppm = 0.0001%</li>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-3 rounded">
              ...
              <p className="text-gray-700">The mg/L = ppm approximation only works for dilute aqueous solutions near room temperature. For seawater (ρ ≈ 1.025 g/mL), organic solvents, or concentrated solutions, always use the actual density in calculations.</p>
            </div>
            ...
            <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-3 rounded">
              ...
              <p className="text-gray-700">Be careful when converting between mg/L, μg/mL, and ppm. While they're numerically equal for water, the conceptual basis differs. Also, remember that molarity and ppm are different—molarity depends on molecular weight while ppm is purely mass-based.</p>
            </div>
            ...
            <div className="border-l-4 border-yellow-500 pl-4 bg-yellow-50 p-3 rounded">
              ...
              <p className="text-gray-700">When dealing with very dilute solutions, the mass of solute is negligible compared to the solvent, so mass_solution ≈ mass_solvent. This simplifies calculations: ppm ≈ (mass_solute / mass_solvent) × 10⁶, avoiding the need to add masses together.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded">
              ...
              <p className="text-gray-600 mt-2">0.025% × 10,000 ppm/% = 250 ppm</p>
            </div>
            
            <div className="bg-gray-50 p-4 rounded">
              <p className="font-semibold text-lime-700 mb-2">Example 3: Gas Phase Calculation</p>
              <p className="text-gray-700">Indoor air contains 800 ppmv CO₂. Express as percentage.</p>
              <p className="text-gray-600 mt-2">800 ppm ÷ 10,000 ppm/% = 0.08% CO₂</p>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded">
              ...
              <p className="text-gray-600 mt-2">Using C₁V₁ = C₂V₂: (1000 ppm)(V₁) = (50 ppm)(500 mL)</p>
              <p className="text-gray-600">V₁ = 25 mL of stock solution, dilute to 500 mL total</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a href="/concentration-and-solution-calculators/ppm-to-molarity-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
            ...
            <a href="/concentration-and-solution-calculators/dilution-calculator" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">C₁V₁ = C₂V₂ calculations</p>
            </a>

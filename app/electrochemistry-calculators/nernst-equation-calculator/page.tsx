                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 animate-slide-in-up animation-delay-400">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-3">
                      <li>
                        <Link 
                          href="/chemistry-formulas/nernst-equation"
                          className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors"
                        >
                          Nernst Equation
                        </Link>
                      ...
                      <li>
                        <Link 
                          href="/chemistry-formulas/cell-potential-formula"
                          className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors"
                        >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Nernst Equation Calculator on ChemSolved",
            "url": "https://chemsolved.com/electrochemistry-calculators/nernst-equation-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Nernst Equation Calculator",
                "item": "https://chemsolved.com/electrochemistry-calculators/nernst-equation-calculator"
              }
            ]
          })
        }}

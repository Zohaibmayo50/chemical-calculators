            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  >
                    <span>→</span>
                    <span>Hess's Law Formula</span>
                  </a>
                </li>
                <li>
                  <a
                    href="/chemistry-formulas/enthalpy-formula"
                    className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                  >
                    <span>→</span>
                    <span>Enthalpy Formula</span>
                  </a>
                </li>
              </ul>
            </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Hess Law Calculator",
            "description": "Hess Law Calculator on ChemSolved",
            "url": "https://chemsolved.com/thermodynamics-calculators/hess-law-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Hess Law Calculator",
                "item": "https://chemsolved.com/thermodynamics-calculators/hess-law-calculator"
              }
            ]
          })
        }}

          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-6">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="/chemistry-formulas/bond-enthalpy-formula"
                    className="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-2"
                  >
                    <span>→</span>
                    <span>Bond Enthalpy Formula</span>
                  </a>
                </li>
                <li>
                  <a
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Bond Energy Calculator on ChemSolved",
            "url": "https://chemsolved.com/thermodynamics-calculators/bond-energy-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Bond Energy Calculator",
                "item": "https://chemsolved.com/thermodynamics-calculators/bond-energy-calculator"
              }
            ]
          })
        }}

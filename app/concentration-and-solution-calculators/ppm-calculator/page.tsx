              ...
              <div className="sticky top-8 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 animate-fade-in" style={{ animationDelay: '100ms' }}>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div className="space-y-2">
                      <Link href="/chemistry-formulas/ppm-formula" className="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                        <p className="font-semibold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400">PPM Formula</p>
                      </Link>
                      <Link href="/chemistry-formulas/ppb-formula" className="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                        <p className="font-semibold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400">PPB Formula</p>
                      </Link>
                    </div>
                  </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/concentration-and-solution-calculators/dilution-calculator'
  }
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://chemsolved.com/concentration-and-solution-calculators/dilution-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Dilution Calculator",
                "item": "https://chemsolved.com/concentration-and-solution-calculators/dilution-calculator"
              }
            ]
          })
        }}

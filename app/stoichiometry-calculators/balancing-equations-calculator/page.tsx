            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-3">
                    <a href="/chemistry-formulas/balancing-equations-formula" className="block p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100">Balancing Equations Formula</h3>
                    </a>
                    <a href="/chemistry-formulas/stoichiometry-formula" className="block p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100">Stoichiometry Formula</h3>
                    </a>
                  </div>
                </div>
                <div className="mt-4">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Balancing Equations Calculator on ChemSolved",
            "url": "https://chemsolved.com/stoichiometry-calculators/balancing-equations-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Balancing Equations Calculator",
                "item": "https://chemsolved.com/stoichiometry-calculators/balancing-equations-calculator"
              }
            ]
          })
        }}

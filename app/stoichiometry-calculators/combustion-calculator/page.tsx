...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/stoichiometry-calculators/combustion-calculator',
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Combustion Calculator on ChemSolved",
            "url": "https://chemsolved.com/stoichiometry-calculators/combustion-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Combustion Calculator",
                "item": "https://chemsolved.com/stoichiometry-calculators/combustion-calculator"
              }
            ]
          })
        }}

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/stoichiometry-calculators/stoichiometry-calculator'
  }
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Stoichiometry Calculator on ChemSolved",
            "url": "https://chemsolved.com/stoichiometry-calculators/stoichiometry-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Stoichiometry Calculator",
                "item": "https://chemsolved.com/stoichiometry-calculators/stoichiometry-calculator"
              }
            ]
          })
        }}

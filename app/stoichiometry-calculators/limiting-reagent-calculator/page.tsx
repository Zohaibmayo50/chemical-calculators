...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chemsolved.com/stoichiometry-calculators/limiting-reagent-calculator'
  }
};
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <Link href="/chemistry-formulas/limiting-reagent-formula" className="block p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1">Limiting Reagent Formula</h3>
                  </Link>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Limiting Reagent Calculator on ChemSolved",
            "url": "https://chemsolved.com/stoichiometry-calculators/limiting-reagent-calculator",
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Limiting Reagent Calculator",
                "item": "https://chemsolved.com/stoichiometry-calculators/limiting-reagent-calculator"
              }
            ]
          })
        }}
